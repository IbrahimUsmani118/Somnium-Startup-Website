            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="text-left">
                        ...
                        <div className="tech-icons-grid bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                            <div className="tech-icon-wrapper">
                                <i className="fab fa-react text-4xl tech-icon"></i>
                                <span className="tech-label">React</span>
                            </div>
                            <div className="tech-icon-wrapper">
                                <i className="fab fa-node-js text-4xl tech-icon"></i>
                                <span className="tech-label">Node.js</span>
                            </div>
                            <div className="tech-icon-wrapper">
                                <i className="fab fa-html5 text-4xl tech-icon"></i>
                                <span className="tech-label">HTML5</span>
                            </div>
                            <div className="tech-icon-wrapper">
                                <svg className="tech-icon" viewBox="0 0 50 31" width="40" height="30">
                                    <path 
                                        fillRule="evenodd" 
                                        clipRule="evenodd" 
